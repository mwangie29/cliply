...
@Composable fun DownloadsScreen() { LazyColumn(Modifier.fillMaxSize().padding(20.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) { item { Text("Downloads", style = MaterialTheme.typography.headlineMedium) }; item { Text("Today", style = MaterialTheme.typography.titleMedium) }; items(listOf("Instagram  ·  9:42 PM  ·  20.1 MB", "TikTok  ·  9:36 PM  ·  14.8 MB")) { CliplyCard(Modifier.fillMaxWidth()) { Text(it, Modifier.padding(18.dp)) } }; item { Text("Yesterday", style = MaterialTheme.typography.titleMedium, modifier = Modifier.padding(top = 12.dp)) }; item { CliplyCard(Modifier.fillMaxWidth()) { Text("Facebook  ·  6:12 PM  ·  31.2 MB", Modifier.padding(18.dp)) } }; item { Text("Earlier", style = MaterialTheme.typography.titleMedium, modifier = Modifier.padding(top = 12.dp)) } } }
