...
class ControlledTestMediaProvider : TestMediaProvider {
    override fun canHandle(url: Uri): Boolean = url.host == "instagram.com" || url.host == "www.instagram.com" || url.host == "tiktok.com" || url.host == "www.tiktok.com" || url.host == "facebook.com" || url.host == "www.facebook.com"
